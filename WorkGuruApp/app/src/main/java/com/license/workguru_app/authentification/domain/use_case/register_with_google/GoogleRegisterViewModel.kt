...
class GoogleRegisterViewModel(val context: Context, val repository: AuthRepository) : ViewModel() {
    ...
    suspend fun googleRegister():Boolean {
        ...
        try {
            ...
            Log.d("AUTH", "Register with google, just made successfully! ${result.access_token} Expires at: ${result.expires_at}")
            ...
            Log.d("AUTH", "GoogleRegisterViewModel - exception: ${e.toString()}")
            return false
        }
    }
}
